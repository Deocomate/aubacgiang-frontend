            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 mb-24 items-center">
                    <div className="prose prose-lg max-w-none flex flex-col justify-center prose-p:font-medium">
                        <div className="text-center md:text-left">
                            ...
                            <h3 className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                                Chào mừng đến với AU Language Institute
                            </h3>
                            <p className="mt-6 leading-8 text-gray-600">
                                "Trung tâm Ngoại ngữ A&U là đơn vị đào tạo tiếng Anh uy tín tại Bắc Ninh, chuyên cung cấp các chương trình học chất lượng cao dành cho mọi lứa tuổi. Với đội ngũ giáo viên giàu kinh nghiệm, cơ sở vật chất hiện đại và giáo trình chuẩn quốc tế, AU cam kết mang đến môi trường học tập chuyên nghiệp, hiệu quả và truyền cảm hứng. Chúng tôi thiết kế các khóa học đa dạng, bao gồm tiếng Anh trẻ em, giao tiếp, luyện thi IELTS, TOEIC, và chương trình tiếng Anh tích hợp theo sách giáo khoa. AU không chỉ chú trọng phát triển kỹ năng ngôn ngữ toàn diện mà còn đồng hành cùng học viên trên hành trình hội nhập và phát triển bản thân trong môi trường quốc tế."
                            </p>
                    ...
                    <div className="w-full">
                        <Image
                            src="/assets/images/vechungtoi.png"
                            alt="Giáo viên và học viên tại AU Language Institute"
                            width={1200}
                            height={628}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                    <div className="w-full h-[400px] md:h-[500px] flex items-center order-last md:order-first">
                        <Image
                            src="/assets/images/tamnhinvasumenh.JPG"
