/* src/pages/ParentsCorner/Detail/components/OtherTestimonialsSection.jsx */
        ...
        <section className="py-16 sm:py-24 border-t bg-gray-50/50">
            <div className="container mx-auto px-4">
                <h2 className="text-2xl font-bold text-gray-900 mb-8 pb-2 border-b-2 border-orange-500 inline-block">
                    Các Chia Sẻ Của Phụ Huynh Khác
                </h2>
                        ...
                        <Link key={item.id} href={`/parents-corner/${item.slug}`} className="block h-full group">
                            <Card className="flex flex-col h-full cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 p-6">
                                <CardContent className="p-0 flex flex-col items-center text-center">
                                    ...
                                    <h4 className="font-bold text-gray-800 group-hover:text-orange-600 transition-colors">{item.name}</h4>
