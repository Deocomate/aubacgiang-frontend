        ...
        <section className="bg-white py-24 sm:py-32">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 mb-24">
                    <div className="prose prose-lg max-w-none h-[600px] flex flex-col justify-center">
                        <div>
                    ...
                    <div className="w-full h-[600px] flex items-center">
                        <Image
                            ...
                            width={600}
                            height={700}
                            className="rounded-xl shadow-2xl object-cover w-full h-[580px] transform hover:scale-105 transition-transform duration-500"
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                    <div className="w-full h-[500px] flex items-center order-last md:order-first">
                        <Image
                            src="/assets/images/R5AT4121.jpg"
                            alt="Môi trường học tập chuyên nghiệp tại A&U"
                            width={600}
                            height={600}
                            className="rounded-xl shadow-2xl object-cover w-full h-[480px] transform hover:scale-105 transition-transform duration-500"
                        />
                    </div>
                    <div className="prose prose-lg max-w-none h-[500px] flex flex-col justify-center">
                        <div>
